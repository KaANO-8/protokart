...
//Verify the content type
  ...
  int i = statement.executeUpdate("insert into products(name,price,quantity,description,categ,tags,image,options) values('"+name+"','"+p+"','"+q+"','"+desc+"','"+category+"','"+tags+"','"+filePath+"','"+options+"')");  
