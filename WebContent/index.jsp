...
<html>
<head>
<title>Protokart -  An Online SuperMarket</title>
				    ...
				    <li class="grid"><a  href="jsp/products.jsp?category=mobiles">mobiles & tablets</a>
					   <div class="megapanel">
						<div class="row">
						 ...
						 <li class="grid"><a  href="jsp/products.jsp?category=health">health & beauty</a>					  
			    </li>		
		  ...
		  <div class="wmuSlider example1">
			 ...
			 <article style="position: absolute; width: 100%; opacity: 0;"> 
				   	<div class="banner-wrap">
						...
						<a href="single.html?productid=3">
			 ...
			 <article style="position: absolute; width: 100%; opacity: 0;"> 
						...
						<div class="banner-top">
						<a href="single.html?productid=1">
						<div class="banner-top-in">
			 ...
			 <article style="position: absolute; width: 100%; opacity: 0;"> 
						...
						<div class="banner-top">
						<a href="single.html?productid=2">
						<div class="banner-top-in">
